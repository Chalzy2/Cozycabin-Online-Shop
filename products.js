...
(function() {
  function initHeroBanner() {
    ...
    function goTo(n) {
      ...
      // Small delay before adding active so CSS animation triggers cleanly
      setTimeout(function() { slides[current].classList.add('active'); }, 10);
    ...
    // Force first slide visible, strip active from all others immediately
    ...
    dotsEl.children[0] && dotsEl.children[0].classList.add('active');
