...
(function injectGalleryCSS() {
  ...
  s.textContent = [
    ...
    '.cc-thumb{flex:0 0 60px;height:60px;border-radius:8px;overflow:hidden;outline:2px solid transparent;outline-offset:2px;cursor:pointer;transition:outline-color .15s;position:relative;}',
    '.cc-th-active{outline-color:#ffd700!important;box-shadow:0 0 0 2px #ffd700;}',
...
(function injectVariantCSS() {
  ...
  s.textContent = [
    ...
    '.vc-pb-btn.vc-pb-active .vc-pb-img{outline-color:#ffd700;box-shadow:0 0 0 2px #ffd700;}',
