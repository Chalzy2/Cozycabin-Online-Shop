...
microwaves: [
  {
    ...
    variants: [
      ...
      },
      {
        ...
        price: 7500,
        oldPrice: 8500,
        description: "20 litres analogue microwave without handle featuring defrost function and 5 power levels.",
      ...
      },
      {
        ...
        price: 8500,
        oldPrice: 9500,
        description: "20 litres digital microwave oven with touch controls, multiple power levels and defrost function.",
  ...
  bags:[], belts:[], blenders:[], bottles:[], chargers:[], cookers:[], dispenser:[], fans:[], racks:[], watches:[],
